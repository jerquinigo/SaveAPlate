...
class VendorProfileThruClient extends Component {
  ...
  //////////////////////////////////////get business hours////////////////////////////////////////////////////////////////////////
  getBusinessHours = () => {
    axios.get(`/api/business_hours/${this.props.match.params.vendor}`)
      .then((info) => {
        this.setState({
...
/////////////////////////////////////get food items////////////////////////////////////////////////////////////////////////
  getfoodItems = () => {
    getFoodItemsByVendor(this.props.match.params.vendor)
      .then((items) => {
        this.setState({
  ...
  return this.state.businessHours.map((time) => {
    ...
    let sun2= Number(time.sun_end.slice(0,2))
      return(
        ...
        <h5> Monday: {mon1 === 0 || mon1  < 13 ? mon1  + "am" : mon1 -12 + "pm"}-{mon2 === 0 || mon2  < 13 ? mon2  + "am" : mon2 -12 + "pm"} </h5>
        <h5> Tuesday: {tue1 === 0 || tue1  < 13 ? tue1  + "am" : tue1 -12 + "pm"}-{tue2 === 0 || tue2  < 13 ? tue2  + "am" : tue2 -12 + "pm"} </h5>
        <h5> Wednesday: {wed1 === 0 || wed1  < 13 ? wed1  + "am" : wed1 -12 + "pm"}-{wed2 === 0 || wed2  < 13 ? wed2  + "am" : wed2 -12 + "pm"} </h5>
        <h5> Thursday: {thu1 === 0 || thu1  < 13 ? thu1  + "am" : thu1 -12 + "pm"}-{thu2 === 0 || thu2  < 13 ? thu2  + "am" : thu2 -12 + "pm"} </h5>
        <h5> Friday: {fri1 === 0 || fri1  < 13 ? fri1  + "am" : fri1 -12 + "pm"}-{fri2 === 0 || fri2  < 13 ? fri2  + "am" : fri2 -12 + "pm"} </h5>
        <h5> Saturday: {sat1 === 0 || sat1  < 13 ? sat1  + "am" : sat1 -12 + "pm"}-{sat2 === 0 || sat2  < 13 ? sat2  + "am" : sat2 -12 + "pm"} </h5>
        <h5> Sunday: {sun1 === 0 || sun1  < 13 ? sun1  + "am" : sun1 -12 + "pm"}-{sun2 === 0 || sun2  < 13 ? sun2  + "am" : sun2 -12 + "pm"} </h5>
        </>
      )
      })
}
